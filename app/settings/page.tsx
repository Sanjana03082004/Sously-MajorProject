...
//                 </div>
//                 <Switch
//                   checked={settings.voiceMonitoring}
//                   onCheckedChange={(v) => updateSetting("voiceMonitoring", v)}
//                 />
//               </div>
...
//                   <div className="font-medium">Background Listening</div>
//                   <div className="text-sm text-gray-500">
//                     Listen for voice commands even when app is closed
//                   </div>
//                 </div>
//                 <Switch
//                   checked={settings.backgroundListening}
//                   onCheckedChange={(v) => updateSetting("backgroundListening", v)}
//                 />
//               </div>
...
//                   onValueChange={(v) => updateSetting("voiceSensitivity", v[0])}
//                   max={100}
//                   step={5}
//                   className="w-full"
//                 />
...
//                   <Shield className="h-4 w-4 text-blue-600 mt-0.5" />
//                   <div className="text-sm text-blue-800">
//                     <strong>Privacy Note:</strong> All voice data is processed locally.
//                     No audio is sent to external servers unless you explicitly enable cloud features.
//                   </div>
//                 </div>
//               </div>
//             </CardContent>
...
//               <div className="space-y-2 text-sm text-gray-600">
//                 <div>• Voice recordings stored locally for 7 days</div>
//                 <div>• Mood data used for insights</div>
//                 <div>• Delete all data anytime</div>
//               </div>
//             </CardContent>
//           </Card>
...
//                   <div className="font-medium">Push Notifications</div>
//                   <div className="text-sm text-gray-500">
//                     Receive wellness reminders and check-ins
//                   </div>
//                 </div>
//                 <Switch
...
//                   <div className="font-medium">Daily Check-ins</div>
//                   <span className="text-sm text-gray-500">
//                     {settings.reminderFrequency} times/day
//                   </span>
//                 </div>
//                 <Slider
//                   value={[settings.reminderFrequency]}
//                   onValueChange={(v) => updateSetting("reminderFrequency", v[0])}
//                   max={8}
//                   min={1}
//                   step={1}
//                   className="w-full"
...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-50 dark:from-gray-900 dark:to-gray-800 transition-colors">
      {/* Header */}
      <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Link href="/">
              <Button variant="ghost" size="icon">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings.backgroundListening}
                  onCheckedChange={(v) =>
                    updateSetting("backgroundListening", v)
                  }
                />
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <div className="font-medium">Push Notifications</div>
                  <div className="text-sm text-gray-500">
                    Receive wellness reminders and mood check-ins
                  </div>
                </div>
                <Switch
                  checked={settings.notifications}
              ...
              <div className="space-y-3">
                ...
                <Slider
                  value={[settings.reminderFrequency]}
                  onValueChange={(v) =>
                    updateSetting("reminderFrequency", v[0])
                  }
                  max={8}
                  min={1}
                  step={1}
